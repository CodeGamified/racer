...
{
    /// <summary>
    /// TUI Manager for Racer — left debugger panel + right status panel.
    /// Same pattern as Snake/Tetris/Breakout TUI managers.
    /// </summary>
    public class RacerTUIManager : MonoBehaviour, ISettingsListener
    {
        ...
        private RacerCodeDebugger _debugger;
        private RectTransform _debuggerRect;

        private RacerStatusPanel _statusPanel;
        ...
        public void Initialize(RacerMatchManager match, RacerProgram program,
        ...
        {
            var canvasGO = new GameObject("RacerTUI_Canvas");
        ...
        private void BuildPanels()
        {
            ...
            _debugger = _debuggerRect.gameObject.AddComponent<RacerCodeDebugger>();
            ...
            _statusPanel = _statusPanelRect.gameObject.AddComponent<RacerStatusPanel>();
